...
public class AddSupplier extends javax.swing.JPanel {
     ...
     * initialize the form.
     * WARNING: Do NOT modify this code.s The content of this method is
    ...
    private void btnAttachActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAttachActionPerformed
        ...
        try {
            ...
            logoImage = new ImageIcon(
                logoImage.getImage().getScaledInstance(150, 150, Image.SCALE_SMOOTH)
            );
            imgLogo.setIcon(logoImage);

        } catch (MalformedURLException ex) {
            Logger.getLogger(this.getName()).log(Level.SEVERE, null, ex);
            // Optionally show a dialog instead of logging only:
