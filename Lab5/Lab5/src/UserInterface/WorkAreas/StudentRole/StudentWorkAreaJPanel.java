...
public class StudentWorkAreaJPanel extends javax.swing.JPanel {
    ...
    CardSequencePanel.add(name, panel);
    ((CardLayout) CardSequencePanel.getLayout()).show(CardSequencePanel, name);
}
    ...
    PlaceholderPanel(String title) {
        ...
        add(new javax.swing.JLabel(title, javax.swing.SwingConstants.CENTER),
